...
def require(*names):
    ...
    # and the rule is not wrong about the shape even though this call only ever
    # read: `globals()[x]` is one character from something callable. No reason
    # to keep the sharper tool when the blunt one does the same job.
